...
<html>
    <head>
        ...
        <link rel="stylesheet" href="styles/home after log in.css">
    </head>
    <body>
        <header>
            ...
            <nav class="container-2">
                <ul class = "menubar">
                    ...
                    <li><a href="booking.html" target="_self">Order a Taxi</a></li>
                    <!--<li><a href="#" target="_self">User Admin</a></li>-->
                    <li><a href="user profile.php" target="_self">User Profile</a></li>
                </ul>
            </nav> 
        </header>
        ...
        <footer>
            ...
            <div class="container-5">
                <div class="cpyright">
                    <p>Copyright &copy DropMe Taxi Company (PVT) Ltd.<br>All Right reserved.</p>
                </div>
            </div>
        </footer>
